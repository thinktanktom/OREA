        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-16 lg:gap-x-12 items-start">
          ...
          <div className="flex flex-col space-y-10">
            ...
            <ul className="space-y-5 text-[10px] tracking-[0.2em] font-light uppercase">
              <li><Link to="/collection" className="hover:text-orea-gold transition-colors duration-500">Rings</Link></li>
              <li><Link to="/collection" className="hover:text-orea-gold transition-colors duration-500">Necklaces</Link></li>
              <li><Link to="/collection" className="hover:text-orea-gold transition-colors duration-500">Earrings</Link></li>
              <li><Link to="/collection" className="hover:text-orea-gold transition-colors duration-500">Bracelets</Link></li>
              <li><Link to="/collection" className="hover:text-orea-gold transition-colors duration-500">Pendants</Link></li>
            </ul>
          </div>
