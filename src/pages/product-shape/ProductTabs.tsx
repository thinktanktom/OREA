        ...
        return (
          <div className="space-y-6 animate-in fade-in duration-700">
             <p className="text-[16px] leading-relaxed text-orea-dark/80 font-serif">
              A celebration of modern love and classic architecture. The {selectedShape} focal stone is held in a minimalist setting, meticulously engineered to catch the light from every angle.
             </p>
          </div>
        );
      case 'details':
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12 text-[12px] font-sans tracking-wide text-orea-taupe animate-in fade-in duration-700">
            <div className="space-y-2">
              ...
              <p>{selectedShape} Cut</p>
            </div>
            <div className="space-y-2">
              <p className="text-[9px] font-bold text-orea-dark uppercase tracking-[0.3em]">Chain Length</p>
              <p>45cm Standard (Adjustable)</p>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <p>Minimalist Four-Prong Basket</p>
            </div>
          </div>
        );
      case 'shipping':
      ...
      case 'warranty':
        return (
          <div className="space-y-4 text-[13px] font-light text-orea-taupe leading-relaxed animate-in fade-in duration-700">
            ...
            <p>Fine jewellery is covered by a 1-Year Manufacturing Warranty, with optional <a href="/pages/concierge" className="underline underline-offset-4 text-orea-dark hover:text-orea-gold transition-colors">ORÉA Concierge Service</a> available for extended care.</p>
