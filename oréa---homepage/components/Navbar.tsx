  ...
  const conciergeData = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Concierge Service', link: '#concierge-service' },
      ]
    },
    {
      category: 'CLIENT CARE',
      links: [
        { name: 'Client Care', link: '#faqs' },
    ...
    >
      <div className="max-w-[1800px] mx-auto px-5 md:px-16 flex justify-between items-center">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 text-center">
          <a href="/" className="font-serif text-2xl md:text-4xl tracking-[0.15em] text-orea-dark hover:opacity-70 transition-opacity duration-700">
            ORÉA
          </a>
        </div>
        ...
        <div className="max-w-[1800px] mx-auto px-16 py-20 flex flex-row gap-24 items-start">
          ...
          <div className="w-full max-w-[380px]">
            <div className="flex flex-col space-y-10">
              <a href="#signature" className="relative group overflow-hidden bg-orea-linen aspect-[4/5] block">
                <img 
          ...
          <div className="w-full max-w-[380px]">
            <div className="flex flex-col space-y-10">
              <a href="#bespoke-process" className="relative group overflow-hidden bg-orea-linen aspect-[4/5] block">
                <img 
