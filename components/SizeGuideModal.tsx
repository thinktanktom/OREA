...
const SizeGuideModal: React.FC<SizeGuideModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center p-4 bg-black/30 backdrop-blur-sm animate-in fade-in duration-500">
      <div className="bg-[#fcfcf9] w-full max-w-2xl p-8 md:p-16 rounded-sm shadow-2xl relative overflow-y-auto max-h-[90vh]">
        ...
        <div className="space-y-16">
          ...
          {/* Conversion Table - Refined for Luxury */}
          <div className="space-y-8">
            <div className="flex justify-between items-baseline border-b border-stone-200 pb-4">
              ...
              <span className="text-[10px] text-stone-400 italic serif">All measurements are approximate</span>
            </div>
          ...
          {/* Sizing Tips - Refined Grid */}
          <div className="pt-8 border-t border-stone-100">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12 text-[12px] text-stone-600 font-light leading-relaxed">
              ...
              <div className="space-y-3">
                ...
                <p>If in doubt, we recommend get in touch with us, or requesting a complimentary ORÉA ring sizer.</p>
              </div>
            </div>
          </div>
