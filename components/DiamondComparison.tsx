  ...
  return (
    <section className="px-6 lg:px-20 overflow-hidden relative">
      ...
      <div className="max-w-6xl mx-auto text-center mb-24">
        <h2 className="text-3xl md:text-5xl font-serif text-stone-900 leading-[1.1] tracking-tight">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-[#2C2621] text-stone-50 rounded-sm overflow-hidden shadow-2xl relative">
            ...
            <table className="w-full text-left border-collapse min-w-[750px]">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="py-10 px-10 text-[9px] uppercase tracking-[0.4em] font-bold text-stone-500 w-1/4">Property</th>
                  <th className="py-10 px-10 text-[11px] uppercase tracking-[0.4em] font-bold text-stone-200 w-[37.5%]">Lab-Grown</th>
                  <th className="py-10 px-10 text-[11px] uppercase tracking-[0.4em] font-bold text-stone-200 w-[37.5%]">Earth-Mined</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                {specs.map((s, i) => (
                  <tr key={i} className="transition-colors">
                    <td className="py-8 px-10 text-[10px] font-bold text-stone-400 uppercase tracking-widest">{s.label}</td>
                    <td className="py-8 px-10 text-base md:text-lg font-serif text-stone-200">
                      {s.lab}
                    </td>
                    <td className="py-8 px-10 text-base md:text-lg font-serif text-stone-200">
                      {s.mined}
          ...
          <div className="p-12 border-t border-white/10 bg-white/[0.01] text-center space-y-4">
